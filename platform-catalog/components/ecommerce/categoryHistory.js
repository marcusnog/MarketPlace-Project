...
function CategoryTab() {
    ...
    return (
        <>
            <div className="section-title style-2 wow animate__animated animate__fadeIn" hidden>
                <h3>Seu historico de Compra</h3>
                
                <ul className="nav nav-tabs links" id="myTab" role="tablist" hidden>
