...
export const canViewMenuGroup = item => {
  ...
  const hasAnyVisibleChild = item.children && item.children.some(i => ability.can('*', '*') || ability.can(i.action, i.resource))
  ...
  return (ability.can('*', '*') || ability.can(item.action, item.resource)) && hasAnyVisibleChild
}
