...
import SidebarAddClient from './SidebarAddClient'

// ** Columns
import { columns } from './columns'

// ** Store & Actions
import { getData, editClient } from '../store/action'
    ...
    <UILoader blocking={loading}>
      <Fragment>
        <Breadcrumb className='mb-2'>
          ...
          <BreadcrumbItem>
            <Link to='/apps/clients'> Clientes </Link>
          </BreadcrumbItem>
        </Breadcrumb>
        <Card>
          <CardHeader>
        ...
        <SidebarAddClient open={sidebarOpen} toggleSidebar={toggleSidebar} currentItem={currentItem} />
      </Fragment>
    </UILoader>
  )
}
